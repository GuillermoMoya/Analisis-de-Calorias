...
const CustomHead = () => {
    const siteTitle = 'Analisis de Calorias - AI Calorie Calculator';
            ...
            <header className="bg-gradient-to-r from-green-400 to-blue-500 shadow-lg">
                <div className="container mx-auto flex justify-between items-center p-5">
                    ...
                    <div className="flex items-center">
                        ...
                        <span className="self-center text-2xl font-bold text-white">Analisis de Calorias - AI Calorie Calculator</span>
                    </div>
                </div>
            </header>
        </div>
